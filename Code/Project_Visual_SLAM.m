...
close all
%% read data
imds = imageDatastore('C:\Users\applegoodeat\Desktop\MySequence6'); 
...
focalLength    = [2.1280e+03 ,2.1231e+03];    % in units of pixels
principalPoint = [860.7214 ,505.6758];    % in units of pixels
